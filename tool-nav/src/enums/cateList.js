...
export const cateList = [
    {
        ...
        children: [
            {
                imgUrl: "src/assets/logos/harbor-horizontal-color.png",
                name: "harbor",
                des: "和利时harbor镜像站",
                url: "http://172.21.44.57",
            },
            {
                imgUrl: "src/assets/logos/gitlab.png",
                name: "git仓库",
                des: "和利时git仓库",
                url: "https://gitlab.hollysys.net",
            }, {
                imgUrl: "src/assets/logos/cm.png",
                name: "CM-jenkins",
                des: "CM-jenkins",
                url: "http://172.21.40.14:8080/jenkins/",
            },
            {
                imgUrl: "src/assets/logos/minio.svg",
                name: "minio",
                des: "minio",
                url: "http://172.21.44.57:9090/",
            }
            , {
                imgUrl: "src/assets/logos/ip.jpeg",
                name: "31代理站",
                des: "31代理站",
                url: "http://172.21.44.31:8080/",
            },
            {
                imgUrl: "src/assets/logos/OIP-C.jpeg",
                name: "57缓存站",
                des: "57缓存站",
                url: "http://172.21.44.57:8081/",
            }
            , {
                imgUrl: "src/assets/logos/down-load.jpeg",
                name: "57下载资源站",
            ...
            {
                imgUrl: "src/assets/logos/sonar.png",
                name: "sonarqube",
                des: "sonarqube",
    ...
    },
    {
        ...
        children: [
            {
                imgUrl: "src/assets/logos/logo.png",
                name: "每日集成环境",
                des: "每日集成环境",
                url: "http://172.21.44.57",
            },
    ...
    },
    {
        ...
        children: [
            {
                imgUrl: "src/assets/logos/PVE.png",
    ...
    },
    {
        ...
        children: [
            {
                imgUrl: "src/assets/logos/alibaba.ico",
                name: "阿里巴巴开源镜像站",
                des: "阿里巴巴开源镜像站",
                url: "https://developer.aliyun.com/mirror/",
            },
            {
                imgUrl: "src/assets/logos/huaweicloud.png",
                name: "华为开源镜像站",
                des: "华为开源镜像站",
                url: "https:mirrors.huaweicloud.com/home",
            },
            {
                imgUrl: "src/assets/logos/email.jpeg",
                name: "内网邮件",
                des: "内网邮件",
                url: "https://mail2010.hollysys.net",
            },
            {
                imgUrl: "src/assets/logos/fillsex-sc.jpeg",
                name: "文件摆渡系统",
                des: "文件摆渡系统",
            ...
            {
                imgUrl: "src/assets/logos/ducker.jpeg",
                name: "docker hub",
                des: "docker hub",
